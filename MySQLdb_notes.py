...
def application(environ, start_response):
    ...
    output += '<style> th, tdd {padding 4px; text-align: center; border-bottom: 4px solid #000000;border-left: 4px solid #000000; border-right: 4px solid #000000}</style>'
    output += '<style>table{border: 1px solid black; border-collapse: collapse;}</style>'
    output += '<font size = 20 face = Courier New>'
    # connect
